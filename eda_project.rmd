...
# change wine quality variable to factor
...
ggplot(data = wines, aes(x = alcohol, y = quality.class)) +
  geom_jitter()
...
ggplot(data = wines, aes(x = density, y = quality)) +
  geom_jitter(aes(color=quality), alpha = 0.5)

ggplot(data = wines, aes(x = density, y = quality.class)) +
  geom_jitter(aes(color=quality.class), alpha = 0.5)
...
ggplot(data = wines, aes(x = chlorides, y = quality.class)) +
  geom_jitter(aes(color = quality.class), alpha = 0.2)
...
ggplot(data = wines, aes(x = chlorides, y = alcohol)) +
  scale_x_continuous(limits = c(0, 0.1)) +
...
ggplot(data = wines, aes(x = alcohol, y =  density)) +
  ...
  geom_smooth(method = "lm", linetype = 2, color = "green") +
